...
const toastflow = createToastflow({
  position: 'bottom-right', offset: '16px', gap: '10px', width: '380px',
  duration: 6000, pauseOnHover: true, pauseStrategy: 'resume', progressBar: true,
  maxVisible: 4, queue: true, order: 'newest', preventDuplicates: true,
  closeButton: true, closeOnClick: false, swipeToDismiss: true,
}, { css: false })
