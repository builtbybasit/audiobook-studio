...
// One correction applied to many lines at once. The action describes *what* to do; the preview says
// what it would actually change before anything is touched, and the result carries the batch undo.
