...
<template>
  ...
  >
    ...
    <SliderThumb
      class="block h-4 w-4 rounded-full border-2 border-violet-500 bg-white shadow transition-transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 dark:bg-zinc-900"
      :aria-label="label"
    />
  </SliderRoot>
</template>
